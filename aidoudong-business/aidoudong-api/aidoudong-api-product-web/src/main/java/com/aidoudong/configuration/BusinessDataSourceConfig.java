...
@Configuration
@MapperScan(basePackages = "com.aidoudong.product.dao.mapper", sqlSessionTemplateRef = "businessSqlSessionTemplate") //扫描Mapper接口
@EnableTransactionManagement // 开启事务管理
@EnableJpaRepositories(
        entityManagerFactoryRef = "entityManagerFactoryBusiness",
        transactionManagerRef = "transactionManagerBusiness",
        basePackages = {"com.aidoudong.product.dao.repository"}
)
public class BusinessDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBusiness(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.aidoudong.product.entity")

...
public class ClientUser implements UserDetails{
	...
	@TableField(exist = false)
	private List<ClientRole> roleList = Lists.newArrayList();
	@TableField(exist = false)
	private List<Long> roleIds = Lists.newArrayList();
	@TableField(exist = false)
	private List<ClientPermission> permissions = Lists.newArrayList();
	...
	public void setPermissions(List<ClientPermission> permissions) {
		this.permissions = permissions;
	}
	@Override
	public String toString() {
		return "ClientUser [id=" + id + ", username=" + username + ", password=" + password + ", isAccountNonExpired="
				+ isAccountNonExpired + ", isAccountNonLocked=" + isAccountNonLocked + ", isCredentialsNonExpired="
				+ isCredentialsNonExpired + ", isEnabled=" + isEnabled + ", authorities=" + authorities + ", nickName="
				+ nickName + ", mobile=" + mobile + ", email=" + email + ", createDate=" + createDate + ", updateDate="
				+ updateDate + ", roleList=" + roleList + ", roleIds=" + roleIds + ", permissions=" + permissions + "]";
	}
